...
<?php $component->withAttributes([]); ?>
    <div class="grid grid-cols-2">
        <div class="flex justify-end pt-4">
            <img src="<?php echo e($product->img); ?>" style="" class="max-w-xs" alt="image">
        </div>
        <div class="pl-10 pt-4">
            ...
            <div class="font-medium text-xl text-gray-500 flex flex-auto pb-1">
                Оцінка: <?php for($i=1; $i<$product->rate; $i++): ?>
            ...
            <div class="font-medium text-xl text-gray-500 pb-1">
                Жанри:
            <?php $__currentLoopData = $product->genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('product.genre', $genre)); ?>" class="font-medium text-xl  pr-1.5 pl-1.5 pt-0.5 pb-0.5 mr-2 text-purple-950 rounded-xl" style="background-color: #7566FE">
            ...
            <div class="font-medium text-xl text-gray-500">
                Рік видання: <?php echo e($product->year); ?>

            </div>
            <div class="font-medium text-xl text-gray-500 pb-1">
                Автор: <?php echo e($f['author']); ?>

            </div>
            <div class="font-medium text-xl text-gray-500 pb-1">
                Перекладач: <?php echo e($f['translator']); ?>

            </div>
            <div class="font-medium text-xl text-gray-500 pb-1">
                Видавництво: <?php echo e($f['vydavnytstvo']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Studies\Vlada\proj_d2\resources\views/product/show.blade.php ENDPATH**/ ?>